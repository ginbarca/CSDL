...
<div class="navbar-header">
	...
	<a class="navbar-brand" href="/QuanLybanDienThoai/trang-chu">ABC Store</a>
</div>
<!-- /.navbar-header -->
<ul class="nav navbar-nav navbar-right">
	<li class="dropdown"><a href="#" class="dropdown-toggle"
		...
		<ul class="dropdown-menu">
			...
			<li class="avatar"><a href="#"> <img
					src="<c:url value="/resources/images/1.png" /> " alt="" />
					<div>New message</div> <small>1 minute ago</small> <span
					class="label label-info">NEW</span>
			</a></li>
			<li class="avatar"><a href="#"> <img
					src="<c:url value="/resources/images/2.png" />" alt="" />
					<div>New message</div> <small>1 minute ago</small> <span
					class="label label-info">NEW</span>
			</a></li>
			<li class="avatar"><a href="#"> <img
					src="<c:url value="/resources/images/3.png"/>" alt="" />
					<div>New message</div> <small>1 minute ago</small>
			</a></li>
			<li class="avatar"><a href="#"> <img
					src="<c:url value="/resources/images/4.png"/>" alt="" />
					<div>New message</div> <small>1 minute ago</small>
			</a></li>
			<li class="avatar"><a href="#"> <img
					src="<c:url value="/resources/images/5.png"/>" alt="" />
					<div>New message</div> <small>1 minute ago</small>
			</a></li>
			<li class="avatar"><a href="#"> <img
					src="<c:url value="/resources/images/pic1.png"/>" alt="" />
					<div>New message</div> <small>1 minute ago</small>
			</a></li>
	...
	<li class="dropdown"><a href="#" class="dropdown-toggle avatar"
		data-toggle="dropdown"><img
			src="<c:url value="/resources/images/1.png" />"><span
